...
public class BaseAdapterHelper {
	 ...
	 *            The view id.
	 * @param color
	 *            A color to use as a background.
	 * @return The BaseAdapterHelper for chaining.
	 */
	@SuppressWarnings("deprecation")
	 ...
	 *            The view id.
	 * @param color
	 *            A color to use as a background. e.g. #ffffff
	 * @return The BaseAdapterHelper for chaining.
	 */
	public BaseAdapterHelper setBackgroundColor(int viewId, String color) {
		View view = retrieveView(viewId);
	 ...
	 * @return The BaseAdapterHelper for chaining.
	 */
	public BaseAdapterHelper setImageUrl(int viewId, String imageUrl, int defaultImg) {
		ImageView imageview = retrieveView(viewId);
		Glide.with(mContext).load(imageUrl).centerCrop().crossFade().error(defaultImg)
